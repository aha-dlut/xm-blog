<template>
  <div class="main-content" style="width: 50%">
    ...
    <el-tabs v-model="activeName" @tab-click="clickTab">
      <el-tab-pane label="我发过的树洞" name="我发过的树洞">
        <div class="card" style="padding: 5px"><el-button type="primary" @click="addBlog">想要发点什么吗</el-button></div>
...
export default {
  ...
  methods: {
    ...
    addBlog() {
      ...
      window.location.href='/front/newBlog'
    },
    clickTab(tab) {
      console.log(tab)
    },
