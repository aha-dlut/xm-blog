  ...
  <div class="manager-container">
    ...
    <div class="manager-main">
      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user','disk']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            <template slot="title">
              <i class="el-icon-menu"></i><span>综合管理</span>
            </template>
            <el-menu-item index="/category">分类管理</el-menu-item>
            <el-menu-item index="/blog">树洞信息</el-menu-item>
          ...
          <el-submenu index="user">
            <template slot="title">
              <i class="el-icon-menu"></i><span>用户数据</span>
            </template>
          ...
          <el-submenu index="disk">
            <template slot="title">
              <i class="el-icon-menu"></i><span>网盘管理</span>
            </template>
